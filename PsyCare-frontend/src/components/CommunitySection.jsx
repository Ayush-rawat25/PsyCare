...
export default function CommunityForum() {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("https://psycare-backend.onrender.com/api/forum", {
  ...
  const handleCreatePost = async () => {
    ...
    try {
      const res = await axios.post(
        "https://psycare-backend.onrender.com/api/forum",
  ...
  const handleLike = async (id) => {
    try {
      const res = await axios.post(
        `https://psycare-backend.onrender.com/api/forum/${id}/like`,
        {},
        { headers: { Authorization: `Bearer ${token}` } }
      );
      setPosts((prev) =>
  ...
  const handleAddComment = async (id) => {
    ...
    try {
      const res = await axios.post(
        `https://psycare-backend.onrender.com/api/forum/${id}/reply`,
  ...
  const handlePrivateMessage = async () => {
    ...
    try {
      await axios.post(
        "https://psycare-backend.onrender.com/api/forum/message",
