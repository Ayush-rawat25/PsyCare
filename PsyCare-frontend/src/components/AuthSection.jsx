...
const AuthSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      let res, data;
      if (isSignUp) {
        res = await fetch("https://psycare-backend.onrender.com/api/auth/signup", {
          method: "POST",
        ...
        res = await fetch("https://psycare-backend.onrender.com/api/auth/login", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
            email: formData.email,
...
<div className="flex justify-center mb-6">
  <button
    ...
    onClick={() => {
      ...
      window.location.href = `https://psycare-backend.onrender.com/api/auth/google`;
    }}
  >
