...
export default function AppointmentsPage() {
  ...
  const fetchAppointments = async () => {
    try {
      const res = await fetch("https://psycare-backend.onrender.com/api/appointments", {
        headers: {
  ...
  const handleCancel = async (id) => {
    try {
      const res = await fetch(`https://psycare-backend.onrender.com/api/appointments/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleClearAll = async () => {
    ...
    try {
      const res = await fetch("https://psycare-backend.onrender.com/api/appointments/clear", {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
